...
# Assumption 1: The file 'data/csharp-training-data/csharp_code_snippets.txt' contains at least two code snippets separated by "\n---\n"
...
def create_codebert_model():
    ...
    example_code_snippets = load_code_snippets("data/csharp-training-data/csharp_code_snippets.txt")
